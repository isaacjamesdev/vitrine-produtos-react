    ...
    return (
      <div>
        <Card style={{ width: "12rem" }}>
          <Card.Img
            variant="top"
            src={tratarPath(this.props.produto.thumbnail)}
          />
          <Card.Body>
            <Card.Title>{this.props.produto.title}</Card.Title>
            <Card.Text>{this.props.produto.variantDescription}</Card.Text>
            <Button
              variant="outline-secondary"
              onClick={() => {
                this.handleShow();
                this.props.moveTo(this.props.produto, "PROMOCOES");
              }}
            >
              + Promoções
            </Button>
            <Button
              ...
              onClick={() => {
                this.handleShow();
                this.props.moveTo(this.props.produto, "FAVORITOS");
              }}
            >
              + Favoritos
            </Button>
            <Button
              ...
              onClick={() => {
                this.handleShow();
                this.props.moveTo(this.props.produto, "COMPRADOS");
              }}
            >
              + Comprados
            </Button>
